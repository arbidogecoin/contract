...
//ARBIDOGE FIRST DOGE MEME COIN ON ARBITRUM BLOCKCHAIN !
//TG: https://t.me/Arbidogecoin

/* 

Contract INFO : 

NAME : ARBIDOGE                     // BUY FEE : 8%
SYMBOL : ARBDOGE                    // SELL FEE : 10%
DECIMAL : 18
...
contract ARBIDOGE is ERC20, Ownable {
    ...
    // Max wallet
    uint256 public _maxWalletSize = (_totalSupply * 18) / 1000;
    uint256 public _maxTxSize = (_totalSupply * 18) / 1000;
